      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <h6 class="card-subtitle mb-1 fw-bold">Tiêu đề Site</h6>
            ...
            <form id="general_s_form">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    <label class="form-label fw-bold">Tiêu đề Site</label>
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <p class="card-text">
              Lưu ý : Không khách hàng nào có thể đặt khi website đã tắt
            </p>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#contacts-s">
                <i class="bi bi-pencil-square"></i> Cài đặt
              </button>
            </div>
            <div class="row">
              <div class="col-lg-6">
        ...
        <div class="modal fade" id="contacts-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <form id="contacts_s_form">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Cài đặt liên hệ (Contact)</h5>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn custom-bg text-white shadow-none">CÀI ĐẶT</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0">Quản lý đội nhóm</h5>
