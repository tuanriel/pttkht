  ...
  if(isset($_GET['seen']))
  {
    ...
    if($frm_data['seen']=='all'){
      ...
      if(update($q,$values,'i')){
        alert('success','Đã đánh dấu đọc tất cả!');
      }
      else{
        alert('error','Không thể thực hiện!');
      }
    }
    else{
  ...
  if(isset($_GET['del']))
  {
    ...
    if($frm_data['del']=='all'){
      ...
      if(mysqli_query($con,$q)){
        alert('success','Tất cả dữ liệu đã xóa!');
      }
      else{
        alert('error','Không thể thực hiệnd!');
      }
    }
    else{
